    ...
    <div className="w-full bg-white py-16 px-6 flex flex-col-reverse lg:flex-row items-center justify-between max-w-7xl mx-auto gap-10">
      ...
      <div className="text-center lg:text-left max-w-xl">
        ...
        <p className="text-gray-500 mb-8">
          Lorem ipsum dolor sit amet consectetur. Sed ultricies fames scelerisque urna quis semper amet.
          Nisl tincidunt tortor nullam est nec commodo orci dictum in. Lorem consectetur donec purus sagittis.
        </p>
        <button className="bg-[#0f1c22] text-white px-6 py-3 rounded hover:bg-[#1c2f34] transition">
      ...
      <div className="relative w-full max-w-sm lg:max-w-md">
        ...
        {/* Floating Review Box */}
        <div className="absolute -top-6 left-1/2 -translate-x-1/2 lg:left-auto lg:-left-20 lg:top-1/2 lg:-translate-y-1/2 bg-white shadow-lg rounded-full px-5 py-2 flex items-center gap-3 z-20">
          {/* Profile Images */}
